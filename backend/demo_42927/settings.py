"""
Django settings for demo_42927 project.
...
WSGI_APPLICATION = 'demo_42927.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_42927 API",
    "DESCRIPTION": "API documentation for demo_42927 App",
    "VERSION": "v1",
}
